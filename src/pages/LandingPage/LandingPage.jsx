            ...
            <div>
                ...
                <nav className="navbar navbar-light bg-light static-top">
                    <div className="container">
                        <Link className="navbar-brand" to="/">WarChest</Link>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-9 mx-auto">
                                <h1 className="mb-5 white">Bảo vệ người tiêu dùng chống mua phải hàng giả hàng nhái</h1>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                    ...
                                    <p className="lead mb-0">Bạn sẽ được cảnh báo mỗi khi xem phải đồ khuyến mại ảo hoặc kém chất lượng</p>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                    ...
                                    <p className="lead mb-0">Chỉ với 3s bạn có thể nhận được kết quả khuyến mãi trên các trang thương mại điện tử </p>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="features-icons-item mx-auto mb-0 mb-lg-3">
                                    ...
                                    <p className="lead mb-0">Không bao giờ còn mất tiền oan vì đồ khuyến mại ảo, đồ dởm</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="showcase">
                    <div className="container-fluid p-0">
                        <div className="row no-gutters">
                            <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: 'url("https://images.pexels.com/photos/34088/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260")' }} />
                            <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                                <h2>Bảo vệ Bạn tại hơn một triệu gian hàng</h2>
                                <p className="lead mb-0">Phát hiện khuyến mại ảo, kém chất lượng trên tất cả các trang mua sắm. Từ đồ điện tử, thời trang, gia dụng, đồ ăn,...</p>
                            </div>
                        </div>
                        <div className="row no-gutters">
                            <div className="col-lg-6 text-white showcase-img" style={{ backgroundImage: 'url("https://images.pexels.com/photos/935756/pexels-photo-935756.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260")' }} />
                        ...
                        <div className="row no-gutters">
                            <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: 'url("https://images.pexels.com/photos/842548/pexels-photo-842548.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260")' }} />
                            <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                                <h2>Dễ dàng sử dụng &amp; thao tác nhanh chóng</h2>
                                <p className="lead mb-0">Tìm kiếm mọi lúc mọi nơi, nhận được kết quả giảm giá nhanh chóng, thuận tiện và dễ dàng</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                                    <img className="img-fluid rounded-circle mb-3" src="data:image/png;base64," alt />
                                    <h5>Fred S.</h5>
                                    <p className="font-weight-light mb-0">"WarChest is amazing."</p>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                ...
                <section className="call-to-action text-white text-center">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-9 mx-auto">
                                <h1 className="mb-4 white">Còn chần chừ gì nữa, dùng WarChest ngay thôi</h1>
                            </div>
                            <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                                <form>
                                    <div className="form-row">
                                        <div className="col-12 col-md-9 mb-2 mb-md-0">
                                            <input type="email" className="form-control form-control-lg" placeholder="Nhập email của bạnbạn..." />
                                        </div>
